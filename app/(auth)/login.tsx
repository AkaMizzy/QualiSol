...
export default function LoginScreen() {
  ...
  return (
    <View style={styles.container}>
      <LinearGradient colors={["#f7f7f7", "#e7e7e7"]} style={styles.gradient} />
      {/* Decorative Shapes */}
      ...
      <SafeAreaView style={styles.safeArea}>
                ...
                <View style={styles.inputContainer}>
                  ...
                  >
                    <Ionicons
                      ...
                      size={22}
                      color={
                        focusedField === "identifier" ? "#f87b1b" : "#6B7280"
                      }
                ...
                <View style={styles.inputContainer}>
                  ...
                  >
                    <Ionicons
                      ...
                      size={22}
                      color={
                        focusedField === "password" ? "#f87b1b" : "#6B7280"
                      }
                      style={styles.inputIcon}
                    />
                    <TextInput
        ...
        <ServerDownModal
          visible={
            (serverStatus === "down" || serverStatus === "error") &&
            !isDownModalDismissed
          }
          ...
          onSuccess={() => {
            ...
            setTimeout(() => {
              setAlert({
                ...
                message:
                  "📩 Un e-mail vous a été envoyé. Veuillez vérifier votre boîte de réception.",
              });
            }, 50);
          }}
        />
        ...
        <TouchableOpacity
          style={[
            styles.healthFab,
            { backgroundColor: getHealthColor(), bottom: bottom + 16 },
          ]}
          disabled
...
const styles = StyleSheet.create({
  ...
  inputWrapper: {
    ...
    borderColor: "#f87b1b",
    height: 56,
    outline: "none" as any, // Remove browser focus outline on web
  },
  inputWrapperFocused: {
    borderColor: "#f87b1b",
    backgroundColor: "#FFFFFF",
