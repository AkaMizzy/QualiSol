...
export function CreateAfterQualiPhotoForm({
  onClose,
  onSuccess,
  parentItem,
  projectTitle,
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerCenter}>
              <Text style={styles.headerTitle} numberOfLines={1}>
                {parentItem.title || `Titre de la photo avant`}
              </Text>
            </View>
...
export default function CreateAfterQualiPhotoModal({
  visible,
  onClose,
  onSuccess,
  parentItem,
