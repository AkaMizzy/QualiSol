...
export default function CreateUserModal({ visible, onClose, onUserCreated }: CreateUserModalProps) {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.identifier.trim()) newErrors.identifier = 'L\'identifiant est obligatoire';
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Omit role_id and status_id - backend will set defaults
          ...
          <ScrollView style={styles.modalContent} showsVerticalScrollIndicator={false}>
            <View style={styles.formContainer}>
              ...
              <View style={styles.formGroup}>
                <Text style={styles.label}>Identifiant <Text style={styles.required}>*</Text></Text>
                <TextInput
              ...
              <View style={styles.formGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) => {
                    ...
                    if (errors.email_second) setErrors({ ...errors, email_second: '' });
                  }}
