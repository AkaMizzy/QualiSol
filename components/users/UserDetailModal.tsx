...
export default function UserDetailModal({
  ...
  const roleStyle = getRoleStyle(currentUser.role?.role);
  const statusStyle = getStatusStyle(currentUser.status?.status);
            ...
            {currentUser.role?.role && (
              ...
              >
                <View style={styles.badgeHeader}>
                  ...
                  />
                  <Text style={[styles.badgeTitle, { color: roleStyle.color }]}>
                    Rôle
                  </Text>
                </View>
            ...
            {currentUser.status?.status && (
              ...
              >
                <View style={styles.badgeHeader}>
                  ...
                  />
                  <Text
                    style={[styles.badgeTitle, { color: statusStyle.color }]}
                  >
                    Statut
                  </Text>
                </View>
