...
export default function ProjectDetailModal({
  ...
  useEffect(() => {
    ...
    if (project.control_id && companyUsers.length > 0) {
      const controlUser = companyUsers.find(
        (u) => String(u.id) === String(project.control_id),
      );
      setControl(
        controlUser
          ? {
              id: String(controlUser.id),
              firstname: controlUser.firstname,
              lastname: controlUser.lastname,
    ...
    if (project.technicien_id && companyUsers.length > 0) {
      const technicienUser = companyUsers.find(
        (u) => String(u.id) === String(project.technicien_id),
      );
      setTechnicien(
        technicienUser
          ? {
              id: String(technicienUser.id),
              firstname: technicienUser.firstname,
              lastname: technicienUser.lastname,
              email: technicienUser.email,
            }
          : null,
      );
      ...
      try {
        ...
        if (!cancelled) {
          if (res.ok && Array.isArray(data)) {
            ...
            const projectZones = data.filter(
              (z: any) => z.project_id === project.id,
            );
                ...
                onPress={async () => {
                  ...
                  try {
                    ...
                    if (control)
                      setControl(
                        companyUsers.find(
                          (u) => String(u.id) === String(editControl),
                        ) || control,
                      );
                    if (technicien)
                      setTechnicien(
                        companyUsers.find(
                          (u) => String(u.id) === String(editTechnicien),
                        ) || technicien,
                      );
              ...
              <Pressable
                onPress={() => {
                  ...
                  if (project) {
                    ...
                    setEditControl(
                      project.control_id ? String(project.control_id) : "",
                    );
                    setEditTechnicien(
                      project.technicien_id
                ...
                {!isEditing ? (
                  ...
                  >
                    ...
                    <Text style={styles.meta}>
                      Contrôleur ·{" "}
                      {control
                        ? `${control.firstname || ""} ${control.lastname || ""}`.trim() ||
                          control.email ||
                          control.id
                        : "—"}
                    </Text>
                        ...
                        <Text style={{ color: "#111827" }} numberOfLines={1}>
                          {editControl
                            ? companyUsers.find(
                              ...
                              ? `${companyUsers.find((u) => String(u.id) === String(editControl))?.firstname} ${companyUsers.find((u) => String(u.id) === String(editControl))?.lastname || ""}`
                              : editControl
                            ...
                            companyUsers.map((u) => (
                              <TouchableOpacity
                                ...
                                style={{
                                  ...
                                  paddingVertical: 10,
                                  backgroundColor:
                                    String(editControl) === String(u.id)
                                      ? "#f1f5f9"
                                      : "#FFFFFF",
                                  borderBottomWidth: 1,
                                  borderBottomColor: "#f3f4f6",
                        ...
                        <Text style={{ color: "#111827" }} numberOfLines={1}>
                          {editTechnicien
                            ? companyUsers.find(
                              ...
                              ? `${companyUsers.find((u) => String(u.id) === String(editTechnicien))?.firstname} ${companyUsers.find((u) => String(u.id) === String(editTechnicien))?.lastname || ""}`
                              : editTechnicien
                            ...
                            companyUsers.map((u) => (
                              <TouchableOpacity
                                ...
                                style={{
                                  ...
                                  paddingVertical: 10,
                                  backgroundColor:
                                    String(editTechnicien) === String(u.id)
                                      ? "#f1f5f9"
                                      : "#FFFFFF",
                                  borderBottomWidth: 1,
                                  borderBottomColor: "#f3f4f6",
                  ...
                  {zones.map((z) => (
                    ...
                    >
                      <View style={styles.zoneHeader}>
                        {getZoneLogoUrl(z) ? (
                          <Image
                            source={{ uri: getZoneLogoUrl(z) as string }}
                        ...
                        <View style={{ flex: 1, marginLeft: 10 }}>
                          ...
                          <Text style={styles.zoneSub} numberOfLines={1}>
                            {z.code || "—"}
                            {z.zone_type_title ? ` · ${z.zone_type_title}` : ""}
                          </Text>
                        </View>
                      </View>
                    </TouchableOpacity>
