...
export default function FolderListScreen({ folderTypeTitle, folderTypeIcon }: FolderListScreenProps) {
  ...
  const fetchFolders = useCallback(async () => {
    ...
    try {
      const fetchedFolders = await folderService.getAllFolders(token, folderTypeTitle);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.filterContainer}>
        ...
        <TouchableOpacity 
          style={[styles.addButton, (!selectedProject || !selectedZone) && styles.addButtonDisabled]} 
